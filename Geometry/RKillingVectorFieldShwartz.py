...
# --- Fix: Use the full internal path for the exporter ---
plotter.export_gltf(r"C:\Users\Abdul\OneDrive\Desktop\RKillingVectorFieldShwartz.gltf")
# -------------------------------------------------------
# ---------------------------------------------------
# Save screenshots
plotter.show(screenshot="RKillingVectorFieldShwartz.png", window_size=[1920, 1080])   # Full HD
